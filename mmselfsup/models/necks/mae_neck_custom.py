...
class MAEPretrainDecoder_custom(MAEPretrainDecoder):
    """Bottleneck for MAE pre-training.
        MODIFIED by No@ FROM mae_neck.py
            IT INCLUDES:
                - Customized attn_drop_rate
    """
    ...
    def __init__(self, 
                 ...
                 **kwargs) -> None:
        super().__init__(decoder_embed_dim=decoder_embed_dim,
        ...
        # Redefine decoder_blocks including attn_drop_rate
...
# @MODELS.register_module()
# class MAEPretrainDecoder_custom(BaseModule):
#     """Bottleneck for MAE pre-training.
#         MODIFIED by No@ FROM mae_neck.py
#             IT INCLUDES:
#                 - Customized attn_drop_rate
